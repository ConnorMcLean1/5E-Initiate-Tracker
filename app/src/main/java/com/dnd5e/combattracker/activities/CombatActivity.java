...
import com.dnd5e.combattracker.dialogs.CombatantsDialog;
import com.dnd5e.combattracker.views.VerticalRatingBar;
...
public class CombatActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, CombatantsDialog.CombatantsDialogListener {
    ...
    ImageButton  endCombatButton, damageHpButton, healHpButton, previousButton, nextButton, saveCombatButton;
